...
| **ICD-10-CM** | `icd10cm`: US clinical modification codes | `is_a` (hierarchy)<br>`maps_to` (ICD-10-CM to ICD-10) | US CDC/NCHS Clinical Modification of ICD-10, with mappings to WHO ICD-10.                                                                                                                        |
